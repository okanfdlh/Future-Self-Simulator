    ...
    const runs = [
      {
        id: "a",
        scenarioId: "neutral",
        metrics: { happiness: 50, finance: 50, health: 50, social: 50, fulfillment: 50 },
      },
      {
        id: "b",
        scenarioId: "positive",
        metrics: { happiness: 80, finance: 70, health: 60, social: 70, fulfillment: 75 },
      },
      {
        id: "c",
        scenarioId: "negative",
        metrics: { happiness: 20, finance: 30, health: 10, social: 25, fulfillment: 15 },
      },
    ]
